...
<title>Scorpio member login</title>
...
<div class="wrapper">
 ...
 <form role="form" class="form-horizontal" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" placeholder="Username (FSOFT account)" id="user_name" name="user_name" class="form-control">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <a class="pull-left" href="/auth/register">Register for new account</a>
      </div>
